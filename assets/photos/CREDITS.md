...
| `head-section.png` | *Head lateral mouth anatomy* by **Patrick J. Lynch**, medical illustrator, [Commons](https://commons.wikimedia.org/wiki/File:Head_lateral_mouth_anatomy.jpg) | **CC BY 2.5** |
...
| `tests/iodine.jpg`, `tests/benedict.jpg`, `tests/biuret.jpg`, `tests/emulsion.jpg` | Topic 4 — Food Tests | `L2.Food Tests.pptx` images 9, 10, 11 and 7 (the iodine photograph cropped below its printed title; the emulsion tube enlarged) — the food-test photographs behind the lenses |
