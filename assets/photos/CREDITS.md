...
Every image in this folder was taken from Dr Mompel's own IGCSE Topic 7 lesson
PowerPoints, so that the simulation shows students the same figures they saw in class.
They are reproduced here for that teaching purpose. If any image needs to be replaced,
drop a new file with the same name into this folder and it will appear automatically.
...
| `villi-and-microvilli-em.jpg` | 7.5 Absorption | `image17.png` |
| `villi-carpet.jpg` | 7.5 Absorption | `image16.jpeg` |
...
| File | Source | Licence |
|---|---|---|
| `haemoglobin-iron.jpg` | *XBio illustration – Hemoglobin* by **explorebiology (XBio)**, [Commons](https://commons.wikimedia.org/wiki/File:XBio_illustration_%E2%80%93_Hemoglobin.png) | **CC BY 4.0** — attribution required. Downscaled to 640px. Labels the haem group and the iron atom at its centre; uses the American spellings *hemoglobin* and *heme*, which the caption points out. |
...
| `mesentery-render.jpg` | *Mesentery extending from the duodenojejunal flexure to the ileocecal junction*, Scientific Animations, [Commons](https://commons.wikimedia.org/wiki/File:Mesentery_extending_from_the_duodenojejunal_flexure_to_the_ileocecal_junction..jpg), cropped | **CC BY-SA 4.0** |
| `tests/iodine.jpg` | *Jodprobe* by **Flo Sorg**, [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Jodprobe.jpg) — iodine solution on mash samples with and without starch; cropped and resized | **Public domain** |
| `tests/benedict.jpg` | *Benedict precipitate 20211012 093950* by **HunterRSC**, [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Benedict_precipitate_20211012_093950.jpg) — brick-red precipitate beside the blue reagent; resized | **CC0** |
| `tests/biuret.jpg` | *Biureedireaktsiooni tulemus* by **Ykskaks3**, [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Biureedireaktsiooni_tulemus.jpg) — purple positive, blue negative; cropped and resized | **CC BY-SA 4.0** |
| `tests/emulsion.jpg` | *Emulsione acqua olio* by **Francesco Mulas**, [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Emulsione_acqua_olio.jpg) — an oil-in-water emulsion beside the unmixed liquids; cropped and resized | **CC BY 3.0** |
| `zoom/microvilli-tem.jpg`, `zoom/microvilli-tem-band.jpg` | *Human jejunum microvilli 1 – TEM* by **Louisa Howard and Katherine Connolly**, Dartmouth College Electron Microscope Facility, via Wikimedia Commons ([file](https://commons.wikimedia.org/wiki/File:Human_jejunum_microvilli_1_-_TEM.jpg)); label strip cropped, turned so the lumen is above; the band is its top | **Public domain** (released by the authors) |
| `zoom/villi-lm.jpg`, `zoom/microvilli-em.jpg` | the two micrographs of his 7.5 deck's villi-and-microvilli figure (`image17.png`, a textbook figure), cut out of it for the plate's magnification ladder; the figure's printed leader lines were painted out of the light micrograph | as the deck figure — teaching use |
| `zoom/pancreas-acinar.jpg` | the pancreas inset of OpenStax College's *Digestive Secretions* figure (in his 7.4 deck, slide 22), cropped to the picture | **CC BY 3.0** |
| `zoom/accessory-organs.jpg` | OpenStax College, *Anatomy & Physiology* fig. 23.24 *Accessory Organs* (Commons *2422 Accessory Organs*), cropped to the organs with the leader lines inpainted out; used for the liver and gall-bladder plates | **CC BY 3.0** |
| `photos/biliary-system-plain2.svg` | the plain biliary plate with the gall bladder moved up under the liver's edge (its old outline masked out of the duct tree, a short neck added), so it reads as sitting on the liver | public domain |
| `zoom/lining-*.jpg`, `zoom/pancreas-render2.jpg` (source arrow inpainted out) | panels cropped from his 7.5 and 7.4 deck figures (circular folds by region; the OpenStax/AnatomyZone pancreas render) for the plate's insets | as the originals |
