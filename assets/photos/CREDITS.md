...
| `tests/iodine.jpg`, `tests/benedict.jpg`, `tests/biuret.jpg`, `tests/emulsion.jpg` | Topic 4 — Food Tests | `L2.Food Tests.pptx` images 9, 10, 11 and 13 (the iodine photograph cropped below its printed title) — the food-test photographs behind the lenses |
