...
(function (global) {
  ...
  var PEEK = {
    ...
    'ethanol emulsion test': ['tests/emulsion.jpg', '<b>Ethanol emulsion test — for fats and oils.</b> Shake the food with ethanol, then pour the ethanol into water. Left: fat or oil present — a <b>cloudy white emulsion</b> swirls out as the fat comes out of the ethanol into the water. Right: none — the water stays clear.', 'From the Topic 4 Food Tests lesson'],
